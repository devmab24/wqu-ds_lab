...
class GarchModel:
    ...
    def wrangle_data(self, n_observations):
        ...
        # Clean data, attach to class as `data` attribute, # Sort DataFrame ascending by date
        df.sort_index(ascending=True, inplace=True)
        # Create "return" column
        df["return"] = df["close"].pct_change() * 100
        
        #Attach data to `self.data` attribute
    ...
    def fit(self, p, q):
        ...
        # Adding Metrics as instance attributes
        self.aic = self.model.aic
        self.bic = self.model.bic
        
    # This is a helper function, if you see it starts with `__`, user won't have access to it, we use it to help our function for cleaning.
